...
function CardTemplate({ type, image }) {
  return (
    <a className="font-sans"  data-aos="flip-right" href="./dashboard">
      <div className="w-full sm:w-[450px] sm:h-[350px] bg-gray-200 hover:bg-white dark:hover:bg-gray-700 transition-all rounded-md h-auto p-4 flex flex-col justify-between gap-3 group dark:bg-gray-900">
