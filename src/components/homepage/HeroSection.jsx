...
function HeroSection() {
  ...
  return (
    ...
    <section className="sm:mt-44 mx-2 sm:mx-10 mt-32 mb-10 sm:mb-32" name="hero">
      <div className="flex flex-col-reverse items-start md:flex-row lg:w-full xl:w-[80%] mx-auto gap-5 md:gap-0">
